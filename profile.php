                ...
                <div class="background-container">
                        <div class="overlay-content">
                            ...
                            <div class="row">
                                ...
                                <a href="log_in.php" role="button" class="pb-3 rounded pills btn btn-primary "> 
                                    Go Back</a>
                                ...
                                <div class="col-md-4 pb-3">
        <a href="profile_edit.php?name=<?= urlencode($row['name']); ?>" role="button" class="pb-3 rounded pills btn btn-secondary">Update Profile</a>
    </div>
